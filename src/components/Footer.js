            ...
            <div className="row">
              <div className="col-md-3">
                ...
                <ul>
                  ...
                  <li>
                    <Link to="#" >                 408, Apollo Premiere, Vijay Nagar
                    </Link>
                  </li>
                  <li>
                    <Link to="#" >                INDORE, Madhya Pradesh 452011, IN
                    </Link>
                  </li>
                </ul>
              </div>
              <div className="col-md-3">
                ...
                <ul>
                  ...
                  <li>
                    <a target="_blank" rel="noreferrer" href="https://www.linkedin.com/company/happiness-plans"> Linkedin</a>
                  </li>
                </ul>
              </div>
            </div>
